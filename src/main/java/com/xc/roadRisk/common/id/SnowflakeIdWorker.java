package com.xc.roadRisk.common.id;
...
public class SnowflakeIdWorker {
     ...
     * 开始时间截 (2018-01-01)
     */
    private final long twepoch = TimeUnit.MILLISECONDS.toSeconds(1514736000000L);
...
//                | sequence;
    ...
    protected long timeGen() {
        ...
        if (currentSecond - twepoch > bitsAllocator.getMaxDeltaSeconds()) {
